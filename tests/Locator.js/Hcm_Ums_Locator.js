export default class Hcm_Ums_Locator {
    constructor(page) {
        ...
        this.extractContractDate = page.locator('td').nth(4).innerText();
        this.clickAdoptionDate = page.locator('//tbody//tr[1]//td[7]')

        //select course 
        this.clickCourse = page.locator('//tr[1]//td[8]//div//div//div//button'); //clicks on the course drop down
        ...
        //select ums
        this.clickUms = page.locator('//tr[1]//td[9]//div//div//div//button');
        ...
        this.clickTenthDoc = page.locator('//tr[1]//td[10]//div//div//div//button'); //clicks on the Tenth Document drop down
        ...
        this.clickTwelvethDoc = page.locator('//tr[1]//td[11]//div//div//div//button'); //clicks on the Twelveth Document drop down
        ...
        this.clickKycDoc = page.locator('//tr[1]//td[12]//div//div//div//button'); //clicks on the KYC Document drop down
        ...
        this.clickPhoto = page.locator('//tr[1]//td[13]//div//div//div//button'); //clicks on the Photo drop down
        ...
        this.clickAbcID = page.locator('//tr[1]//td[14]//div//div//div//button'); //clicks on the ABC ID drop down
